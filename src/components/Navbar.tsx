        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <a
              ...
              className="flex items-center ml-2 brutal-border-thin bg-white text-sm font-bold overflow-hidden hover:shadow-[2px_2px_0px_#1a1a1a] transition-shadow"
            >
              ...
              {stars !== null && (
                <span className="border-l-2 border-foreground bg-foreground text-white px-2.5 py-1.5 text-xs font-bold">
